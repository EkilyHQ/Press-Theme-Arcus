...
if (!theme.engines || theme.engines.press !== '>=3.4.132 <4.0.0') {
  throw new Error('theme/theme.json must declare engines.press for Press v3.4.132 theme settings compatibility');
}
